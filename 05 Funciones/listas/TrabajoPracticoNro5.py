...
listaVacia = [];
listaVacia.append("Agua");
listaVacia.append("Aire");
listaVacia.append("tierra"); 
print(listaVacia); 
...
## ACA IRIA LA FOTO DEL PROGRAMA##

# El programa realiza la eliminacion de el elemento de mayor valor en la lista numeros, que en este caso seria el 22. 
